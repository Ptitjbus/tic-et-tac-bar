...
import discoverImg from "~/assets/img/discover.jpg"
...
export default {
  ...
  setup() {
    ...
    const texts = ref([
      ...
      "Au cœur du projet se trouve une véritable passion pour les liqueurs signature. Théo et Carl ont consacré des centaines d'essais à élaborer ces recettes uniques, qui sont aujourd'hui la signature de leurs cocktails.",
